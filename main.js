...
// Q3
console.log("// Q3");
let personNameTwo = "John Doe";
// Lowercase
let lowercaseName = personNameTwo.toLowerCase();
console.log("Lowercase: " + lowercaseName);
// Uppercase
let uppercaseName = personNameTwo.toUpperCase();
console.log("Uppercase: " + uppercaseName);
// Titlecase 
let titlecaseName = personNameTwo.replace(/\b\w/g, c => c.toUpperCase());
...
let quoteTwo = "A person who never made a mistake never tried anything new.";
let message = `${famous_person} once said, "${quoteTwo}"`;
console.log(message);
// Q6
console.log("// Q6");
...
// Q18
console.log("// Q18");
let placesToVisit = ["Paris", "Tokyo", "New York", "Rome", "Rio de Janeiro"];
...
// Q20
console.log("// Q20");
let favoriteThings = ["mountains", "rivers", "countries", "cities", "languages"];
...
// Q32
console.log("// Q32");
let currentUsers = ["Alice", "Bob", "Charlie", "David", "Eve"];
let newUsers = ["alice", "Frank", "George", "eve", "Hannah"];
...
// Q34
console.log("// Q34");
let pizzaTypes = ["Pepperoni", "Margherita", "BBQ Chicken"];
...
let myFoods = ["pizza", "falafel", "carrot cake"];
let friendFoods = [...myFoods];
...
let magicians = ["Houdini", "Blaine", "Copperfield"];
...
console.log("// Q39");
// A function to create and display a list of magician names
function showMagiciansNew(magicians) {
    for (let magician of magicians) {
        console.log(magician);
    }
}
// Q40
console.log("// Q40");
let magicianNames = ["Houdini", "Blaine", "Copperfield"];
showMagiciansNew(magicianNames);
let greatMagicianNames = makeGreat([...magicianNames]);
